...
// Run archiver opportunistically
runArchiver($pdo);

// Fetch latest 8 annonces
$cards = [];
try {
    $stmt = $pdo->query("SELECT a.id, a.titre, a.description, a.date_publication, a.etat, a.image_path, a.prix, a.ville, a.categorie, u.nom AS auteur
                          FROM annonces a JOIN utilisateurs u ON a.id_utilisateur = u.id
                          WHERE a.moderation_status = 'approved'
                          ORDER BY a.date_publication DESC LIMIT 8");
    $cards = $stmt->fetchAll();
} catch (Throwable $e) {
    $cards = [];
}
...
<body class="grid">
  ...
  <section class="banner">
    <div class="container banner-inner">
      <div>
        ...
        <p>Browse the latest listings across categories and cities. Login to post your ad!</p>
        <div style="margin-top:12px; display:flex; gap:10px;">
          <a class="btn" href="user-consult.php">Browse Listings</a>
          <a class="btn secondary" href="login.php">Login to Post</a>
        </div>
        ...
        <div class="chips" aria-label="Popular categories">
          ...
          <a class="chip" href="filter.php?category=Clothing">👗 Clothing</a>
  ...
  <main class="container">
    <div class="section-title">
      ...
      <a class="btn ghost" href="user-consult.php">See all</a>
    </div>
          ...
          <article class="card">
            ...
            <div class="card-body">
              ...
              <div class="card-actions">
                ...
                <a class="btn" href="user-consult.php">More like this</a>
              </div>
            </div>
          </article>
        <?php endforeach; ?>
